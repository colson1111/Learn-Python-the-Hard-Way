...
class TheBridge(Scene):
	...
	def enter(self):
		...
		if action == "throw the bomb":
			...
			print "DOES NOT COMPUTE! Maybe you can throw the bomb, or stand there stupidly, or slowly place the bomb"
			return "the_bridge"
...
class EscapePod(Scene):
	...
	def enter(self):
		...
		print "but you don't have time to look.  There are 3 pods, which one"
		print "do you take?"
